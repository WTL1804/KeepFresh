...
//            [user synchronize];
        ...
        [[KeepFreshManage sharedLeton] loginUserToBackGroundWithUser:array[0] pass:array[1] success:^(LoginJSONModel * _Nonnull loginJSONModel) {
            ...
            //记录登录状态
                ...
                NSString *cookieValue =  [[KeepFreshManage sharedLeton] ObtaionCookie];
                ...
                if (self.headImage != nil) {
                    ...
                    [[KeepFreshManage sharedLeton] uploadImageWithImageData:imageData JSESSIONID:cookieValue success:^(UploadImageModel * _Nonnull uploadModel) {
