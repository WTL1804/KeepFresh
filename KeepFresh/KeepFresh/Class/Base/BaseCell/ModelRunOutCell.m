...
#import "ModelRunOutCell.h"
#import "ModelRunOut.h"
#import <Masonry.h>
@implementation ModelRunOutCell
- (void)setLayOutInSubclass:(BaseModel *)baseModel {
     _modelRunOut = (ModelRunOut *)baseModel;
    
    _imageViewOfItems = [[UIImageView alloc] initWithImage:[UIImage imageWithData:_modelRunOut.imageData]];
    ...
    NSString *date = [dateFormatter stringFromDate:_modelRunOut.overDue];
    ...
    stringDate = @"添加日期";
    date = [dateFormatter stringFromDate:_modelRunOut.addDate];
    stringDate = [stringDate stringByAppendingString:date];
    _addDateLabel.text = stringDate;
    [self addSubview:_addDateLabel];
    
    _titleLabel = [[UILabel alloc] init];
    _titleLabel.text = _modelRunOut.name;
    [self addSubview:_titleLabel];
    
    _attributeLabel = [[UILabel alloc] init];
    _attributeLabel.text = _modelRunOut.attribute;
...
//        NSDateComponents *comp = [calendar components:NSCalendarUnitDay fromDate:[NSDate date] toDate:_modelRunOut.overDue options:NSCalendarWrapComponents];
//        NSNumber *number = [NSNumber numberWithInteger:comp.day];
//        CGFloat percentage = [number doubleValue] / [_modelRunOut.shelfLifeNumber doubleValue];
